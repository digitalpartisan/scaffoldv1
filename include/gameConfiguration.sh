...
readonly SCAFFOLD_PATH_GAME_CONFIG="$SCAFFOLD_PATH_GAME/$SCAFFOLD_NAME_FILE_CONFIG_GAME"
...
readonly SCAFFOLD_PATH_GAME_SCRIPTEXTENSION="$SCAFFOLD_GAME_SCRIPT_EXTENSION"
